...
import { mixPlan, clients } from '../../lib/data'
  ...
  return (
    <AppShell>
      <div className="px-4.5 md:px-8 pt-4 md:pt-8 pb-6 max-w-3xl">
        <div className="eyebrow">Pedido sugerido · {client.name}</div>
        <h2 className="font-display text-[19px] font-bold text-text-primary mt-1.5">
          Baseado no histórico de compra
        </h2>
        <div className="font-mono text-[13px] text-text-primary font-medium mt-1">
          Investimento sugerido: R$ {mixPlan.investment.toLocaleString('pt-BR')}
        </div>
